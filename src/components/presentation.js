import MyIAvatar from './img/MyIAvatar.png'

function Presentation() {
    return (
        <div className="container-lg text-black my-5">
            <div className="row ">
            ...
            <div className="row my-3 " >
                ...
                {<img  className="mg-fluid  rounded-pill w-75 "roundedCircle  src={MyIAvatar} alt="BigCo Inc. logo" />}
